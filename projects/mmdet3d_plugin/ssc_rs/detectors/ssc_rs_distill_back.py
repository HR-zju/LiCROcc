...
class SSC_RS(MVXTwoStageDetector):
    ...
    def step(self, points, img_metas, img_feats):
        ...
        x, bev_t_list = self.pts_bbox_head(inputs, ss_out_dict['mss_bev_dense'], sc_out_dict['mss_bev_dense'], img_feats)
    ...
    def radar_step(self, points, img_metas, img_feats):
        ...
        return x, ss_out_dict, sc_out_dict, bev_s_list
    ...
    def Distill_1_loss(self, bev_s, bev_t, target, ratio):
        """
    ...
    # breakpoint()
        ...
        if self.Distill_2:
            ...
            for batch_i in range(len(img_metas)):
                ...
                for list_i in range(len(bev_s_list)):
                    ...
                    source_features = bev_s_list[list_i][batch_i][:, mask_list[list_i]]
        ...
        if self.Distill_3:
            ...
            for batch_i in range(len(img_metas)):
                ...
                # ]
                # breakpoint()
                cosine_s = self.calculate_cosine_similarity(bev_s_list[-1][batch_i], bev_s_list[-1][batch_i], mask)
            ...
            Distill_3_loss *= self.ratio_distill
            # breakpoint()
        ...
        if self.Distill_1: # kl
            ...
            distill_loss_1 = self.Distill_1_loss(bev_s_reshaped, bev_t_reshaped, target_reshaped, self.ratio_distill)
            # pass
    ...
    def forward_test(self,
        ...
        if self.use_radar:
            outs, _, _,_ = self.radar_step(radar_pc, img_metas, [None,None,None])
